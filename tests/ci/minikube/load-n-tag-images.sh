...
LATEST_K8S_SHELL_IMAGE=$1
MYSQL_SHELL_IMAGE=$2
MYSQL_SHELL_ENTERPRISE_IMAGE=$3

minikube start
minikube image load $LATEST_K8S_SHELL_IMAGE
minikube ssh docker tag $LATEST_K8S_SHELL_IMAGE $MYSQL_SHELL_IMAGE
minikube ssh docker tag $LATEST_K8S_SHELL_IMAGE $MYSQL_SHELL_ENTERPRISE_IMAGE
