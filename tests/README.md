...
* OPERATOR_TEST_SKIP_S3
* OPERATOR_TEST_OCI_S3_ENDPOINT
* OPERATOR_TEST_OCI_S3_PROFILE
* OPERATOR_TEST_OCI_S3_CONFIG_PATH
* OPERATOR_TEST_OCI_S3_CREDENTIALS_PATH
* OPERATOR_TEST_S3_BUCKET
* OPERATOR_TEST_S3_ENDPOINT
* OPERATOR_TEST_S3_PROFILE
* OPERATOR_TEST_S3_CONFIG_PATH
* OPERATOR_TEST_S3_CREDENTIALS_PATH
