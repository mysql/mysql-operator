...
```sh
$> kubectl apply -f https://raw.githubusercontent.com/mysql/mysql-operator/8.4.8-2.1.10/deploy/deploy-crds.yaml
```

Then deploy MySQL Operator for Kubernetes:

```sh
$> kubectl apply -f https://raw.githubusercontent.com/mysql/mysql-operator/8.4.8-2.1.10/deploy/deploy-operator.yaml
```
