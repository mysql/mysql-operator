...
class ScheduledBackupTimestamp(tutil.OperatorTest):
    default_allowed_op_errors = COMMON_OPERATOR_ERRORS
    cluster_name = "mycluster"
    volume_name = "ote-scheduled-timestamp-vol"
    profile_name = "scheduled-timestamp-backup"
    schedule_name = "schedule-timestamp"
