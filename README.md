...
```sh
$> kubectl apply -f https://raw.githubusercontent.com/mysql/mysql-operator/9.0.0-2.2.0/deploy/deploy-crds.yaml
```

Then deploy MySQL Operator for Kubernetes:

```sh
$> kubectl apply -f https://raw.githubusercontent.com/mysql/mysql-operator/9.0.0-2.2.0/deploy/deploy-operator.yaml
```
