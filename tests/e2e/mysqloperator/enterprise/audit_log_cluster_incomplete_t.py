...
class AuditLogClusterIncomplete(AuditLogBase):
    ...
    def test_3_verify_log(self):
        ...
        log_data_0 = self.get_log_data(self.instance_primary, self.__class__.add_data_timestamp)
        ...
        log_data_1 = self.get_log_data("mycluster-1", self.__class__.add_data_timestamp)
