...
OPERATOR_VERSION_TAG = os.getenv(
    "OPERATOR_TEST_VERSION_TAG", default="26.7.0-2.3.0")
...
DEPLOY_PATH = os.getenv(
    "OPERATOR_TEST_DEPLOY_PATH")

DEPLOY_HISTORIC_PATH = os.getenv(
    "OPERATOR_TEST_DEPLOY_HISTORIC_PATH")
