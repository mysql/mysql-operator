...
License information can be found in the [LICENSE](https://github.com/mysql/mysql-operator/blob/8.0.43-2.0.19/LICENSE) file.
...
```sh
$> kubectl apply -f https://raw.githubusercontent.com/mysql/mysql-operator/8.0.43-2.0.19/deploy/deploy-crds.yaml
```

Then deploy MySQL Operator for Kubernetes:

```sh
$> kubectl apply -f https://raw.githubusercontent.com/mysql/mysql-operator/8.0.43-2.0.19/deploy/deploy-operator.yaml
```
